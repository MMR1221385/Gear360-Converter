...
rem This is a program can convert Samsung Gear360 to Standard Panorama photos
rem (Hugin neede)
rem
rem https://github.com/MMR1221385/Gear360-Converter
...
set INNAME=
set PTOTMPL=
set OUTDIR=%SCRIPTPATH%Gear360-Created
set JPGQUALITY=97
...
if "%CREATEGALLERY%" == "yes" if not "%OUTDIR%" == "Gear360-Created" (
  if /i not "%OUTDIR%" == "Gear360-Created" (
    echo.
    echo Gallery file list will be updated but output directory is not set to "Gear360-Created"
    echo.
  )
)
...
:NOHUGIN
echo.
echo Hi. I'm MohammadMahdiRezaei. I'm sorry but Hugin is not installed or installed in non-standard directory
echo Download and install Hugin from: http://hugin.sourceforge.net/
echo Please install Hugin in default directory :
echo "C:\Program Files\Hugin\bin" or 
echo "C:\Program Files (x86)\Hugin\bin"
