...
set INNAME=
set PTOTMPL=
set OUTDIR=%SCRIPTPATH%Gear360-OK-Created
set JPGQUALITY=100
set PTOJPGFILENAME=PTO-JPG-FILENAME.jpg
...
echo Hi.
echo Good lock.
echo I write this script for Samsung Gear 360 - 2016.
echo.
echo Usage:
...
echo    default: Gear360-OK-Created
...
:NOHUGIN
echo.
echo Hi, I'm MohammadMahdi Rezaei. Please install Hugin.
...
:NONAERROR
echo nona failed, panorama from bad original photo not created
set EXITCODE=1
goto eof
...
rem I'm MohammadMahdi Rezaei, Good By
exit /b 0
